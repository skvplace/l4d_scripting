...
public Plugin myinfo = 
{
	...
	author 		= "Skv",
	description = "Teleports lagging survivors to elevators, shelters, and rescue vehicles",
	version 	= "2.9",
...
void OnEndTouch_Elevator_Delay(Handle timer, Handle data)
{
...
void OnEndTouch_Delay(Handle timer, Handle data)
{
	if (!IsValidHandle(data))
	{
		return;
