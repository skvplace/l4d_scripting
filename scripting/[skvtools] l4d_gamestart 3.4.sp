...
any native_IsServerEmpty(Handle plugin, int numParams)
{
	return gb_server_empty;
}
...
public void OnClientPostAdminCheck(int client)
{
	...
	if (!SetUserConnect(GetClientUserId(client)))
	{
		return;
	}
