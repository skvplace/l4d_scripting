...
void EventEnable_MISSION_LOST()
{
	if (!gb_eventhook[MISSION_LOST])
	{
		gb_eventhook[MISSION_LOST] = true;
		HookEvent("mission_lost", Event_mission_lost);
	}
}

void EventDisable_MISSION_LOST()
{
	if (gb_eventhook[MISSION_LOST])
	{
		gb_eventhook[MISSION_LOST] = false;
