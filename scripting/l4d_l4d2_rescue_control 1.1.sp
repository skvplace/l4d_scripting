...
public OnPluginStart()
{
	...
	gc_rescue_door_opening = CreateConVar("rescue_rescue_door_opening", "1", "Enables automatic door opening when a survivor approaches", _, true, 0.0, true, 1.0);
	SetConVarFlags(gc_rescue_door_opening, GetConVarFlags(gc_rescue_door_opening) & ~FCVAR_NOTIFY);
	
	gc_rescue_door_opening_distance = CreateConVar("rescue_rescue_door_opening_distance", "300", "Sets the automatic door opening distance", _, true, 200.0, true, 800.0);
